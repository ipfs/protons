...
export interface OptionPackedTypes {
  doubles: number[]
  floats: number[]
  int32s: number[]
  int64s: bigint[]
...
export interface OptionPackedTypesInput {
  doubles?: number[]
  floats?: number[]
  int32s?: number[]
  int64s?: bigint[]
...
export namespace OptionPackedTypes {
  let _codec: Codec<OptionPackedTypes, OptionPackedTypesInput>

  export const codec = (): Codec<OptionPackedTypes, OptionPackedTypesInput> => {
    if (_codec == null) {
      _codec = message<OptionPackedTypes, OptionPackedTypesInput>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
  ...
  export interface OptionPackedTypesDoublesFieldEvent {
    field: '.doubles[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesFloatsFieldEvent {
    field: '.floats[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesInt32sFieldEvent {
    field: '.int32s[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesInt64sFieldEvent {
    field: '.int64s[]'
    index: number
    value: bigint
  }

  export interface OptionPackedTypesUint32sFieldEvent {
    field: '.uint32s[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesUint64sFieldEvent {
    field: '.uint64s[]'
    index: number
    value: bigint
  }

  export interface OptionPackedTypesSint32sFieldEvent {
    field: '.sint32s[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesSint64sFieldEvent {
    field: '.sint64s[]'
    index: number
    value: bigint
  }

  export interface OptionPackedTypesFixed32sFieldEvent {
    field: '.fixed32s[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesFixed64sFieldEvent {
    field: '.fixed64s[]'
    index: number
    value: bigint
  }

  export interface OptionPackedTypesSfixed32sFieldEvent {
    field: '.sfixed32s[]'
    index: number
    value: number
  }

  export interface OptionPackedTypesSfixed64sFieldEvent {
    field: '.sfixed64s[]'
    index: number
    value: bigint
  }

  export interface OptionPackedTypesBoolsFieldEvent {
    field: '.bools[]'
    index: number
    value: boolean
  }

  export function encode (obj: OptionPackedTypesInput): Uint8Array<ArrayBuffer> {
    return encodeMessage(obj, OptionPackedTypes.codec())
  }

  export function decode (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<OptionPackedTypes>): OptionPackedTypes {
    return decodeMessage(buf, OptionPackedTypes.codec(), opts)
  }

  export function stream (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<OptionPackedTypes>): Generator<OptionPackedTypesDoublesFieldEvent | OptionPackedTypesFloatsFieldEvent | OptionPackedTypesInt32sFieldEvent | OptionPackedTypesInt64sFieldEvent | OptionPackedTypesUint32sFieldEvent | OptionPackedTypesUint64sFieldEvent | OptionPackedTypesSint32sFieldEvent | OptionPackedTypesSint64sFieldEvent | OptionPackedTypesFixed32sFieldEvent | OptionPackedTypesFixed64sFieldEvent | OptionPackedTypesSfixed32sFieldEvent | OptionPackedTypesSfixed64sFieldEvent | OptionPackedTypesBoolsFieldEvent> {
    return streamMessage(buf, OptionPackedTypes.codec(), opts)
  }
}

export interface OptionExpandedTypes {
  doubles: number[]
  floats: number[]
  int32s: number[]
  int64s: bigint[]
...
export interface OptionExpandedTypesInput {
  doubles?: number[]
  floats?: number[]
  int32s?: number[]
  int64s?: bigint[]
...
export namespace OptionExpandedTypes {
  let _codec: Codec<OptionExpandedTypes, OptionExpandedTypesInput>

  export const codec = (): Codec<OptionExpandedTypes, OptionExpandedTypesInput> => {
    if (_codec == null) {
      _codec = message<OptionExpandedTypes, OptionExpandedTypesInput>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
  ...
  export interface OptionExpandedTypesDoublesFieldEvent {
    field: '.doubles[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesFloatsFieldEvent {
    field: '.floats[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesInt32sFieldEvent {
    field: '.int32s[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesInt64sFieldEvent {
    field: '.int64s[]'
    index: number
    value: bigint
  }

  export interface OptionExpandedTypesUint32sFieldEvent {
    field: '.uint32s[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesUint64sFieldEvent {
    field: '.uint64s[]'
    index: number
    value: bigint
  }

  export interface OptionExpandedTypesSint32sFieldEvent {
    field: '.sint32s[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesSint64sFieldEvent {
    field: '.sint64s[]'
    index: number
    value: bigint
  }

  export interface OptionExpandedTypesFixed32sFieldEvent {
    field: '.fixed32s[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesFixed64sFieldEvent {
    field: '.fixed64s[]'
    index: number
    value: bigint
  }

  export interface OptionExpandedTypesSfixed32sFieldEvent {
    field: '.sfixed32s[]'
    index: number
    value: number
  }

  export interface OptionExpandedTypesSfixed64sFieldEvent {
    field: '.sfixed64s[]'
    index: number
    value: bigint
  }

  export interface OptionExpandedTypesBoolsFieldEvent {
    field: '.bools[]'
    index: number
    value: boolean
  }

  export function encode (obj: OptionExpandedTypesInput): Uint8Array<ArrayBuffer> {
    return encodeMessage(obj, OptionExpandedTypes.codec())
  }

  export function decode (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<OptionExpandedTypes>): OptionExpandedTypes {
    return decodeMessage(buf, OptionExpandedTypes.codec(), opts)
  }

  export function stream (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<OptionExpandedTypes>): Generator<OptionExpandedTypesDoublesFieldEvent | OptionExpandedTypesFloatsFieldEvent | OptionExpandedTypesInt32sFieldEvent | OptionExpandedTypesInt64sFieldEvent | OptionExpandedTypesUint32sFieldEvent | OptionExpandedTypesUint64sFieldEvent | OptionExpandedTypesSint32sFieldEvent | OptionExpandedTypesSint64sFieldEvent | OptionExpandedTypesFixed32sFieldEvent | OptionExpandedTypesFixed64sFieldEvent | OptionExpandedTypesSfixed32sFieldEvent | OptionExpandedTypesSfixed64sFieldEvent | OptionExpandedTypesBoolsFieldEvent> {
    return streamMessage(buf, OptionExpandedTypes.codec(), opts)
  }
}
